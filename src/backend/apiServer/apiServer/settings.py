...
SECRET_KEY = 'django-insecure-r!fjmre_q@ui2-99b38^6uiw#8k4def!5898xlc296fy6&p+ul'
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'konla.apps.KonlaConfig',
]

MIDDLEWARE = [
    'konla.allowCredentialMiddleware.credentialMiddleware',
